export default function Footer() {
  return (
    <footer id="contact" className="bg-red-500 text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-white/80 mt-2">Healthy Indian meals for today’s professionals.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-white/80 mt-2">Instagram • X • LinkedIn</p>
        </div>
      </div>
      <div className="border-t border-white/20">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 text-sm text-center">
